...
Es genügt das Token als Attribut des Header-Elements zu setzen.

Die programmatische Einbindung via HandlerResolver ist noch zu ergänzen.
Anschließend sollte auf der Server-Seite die Erweiterung im SOAP-Paket
sichtbar sein.
