...
//		System.out.println(answer);
		...
		Dispatch<SOAPMessage> dispatch = service.createDispatch(new QName("http://train.sk/","HelloWorldPort"), SOAPMessage.class, Service.Mode.MESSAGE);
...
//		SOAPMessage.class, Service.Mode.MESSAGE);
		...
		SOAPElement operation = body.addBodyElement(new QName("http://train.sk/", "sayHello"));
