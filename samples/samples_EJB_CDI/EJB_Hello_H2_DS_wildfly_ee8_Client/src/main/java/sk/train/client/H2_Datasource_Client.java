...
public class H2_Datasource_Client {
	...
	public static void main(String[] args) throws NamingException, SQLException {
		...
		// laut Standard: context.lookup("java:global/EJB_Hello_H2_DS_wildfly_ee8-0.0.1-SNAPSHOT/Hello_DS_Bean!sk.train.Hello_DS_BeanRemote");
		// bei JBoss
		Hello_DS_BeanRemote stub = (Hello_DS_BeanRemote) 
				context.lookup("ejb:/EJB_Hello_H2_DS_wildfly_ee8/Hello_DS_Bean!sk.train.Hello_DS_BeanRemote");
