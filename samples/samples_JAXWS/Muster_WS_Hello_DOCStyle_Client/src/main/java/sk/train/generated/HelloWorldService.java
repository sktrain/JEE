 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://train.sk/", wsdlLocation = "http://localhost:8080/Hello_WS_DOCStyle/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Hello_WS_DOCStyle/HelloWorld?wsdl");
